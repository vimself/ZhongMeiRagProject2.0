...
VLLM_SPECULATIVE_CONFIG = os.getenv("GLM_VLLM_SPECULATIVE_CONFIG", "")
...
GLM_TEMPERATURE = float(os.getenv("GLM_TEMPERATURE", "0.0"))
GLM_TOP_P = float(os.getenv("GLM_TOP_P", "0.00001"))
GLM_TOP_K = int(os.getenv("GLM_TOP_K", "1"))
GLM_REPETITION_PENALTY = float(os.getenv("GLM_REPETITION_PENALTY", "1.2"))
GLM_IMAGE_FORMAT = os.getenv("GLM_IMAGE_FORMAT", "PNG").upper()
...
GLM_TEXT_LINE_REPAIR_ENABLED = _bool("GLM_TEXT_LINE_REPAIR_ENABLED", True)
GLM_TEXT_LINE_REPAIR_POLICY = os.getenv("GLM_TEXT_LINE_REPAIR_POLICY", "auto").strip().lower()
GLM_TEXT_LINE_REPAIR_MIN_LINES = int(os.getenv("GLM_TEXT_LINE_REPAIR_MIN_LINES", "2"))
GLM_TEXT_LINE_REPAIR_MAX_LINES = int(os.getenv("GLM_TEXT_LINE_REPAIR_MAX_LINES", "36"))
GLM_TEXT_LINE_REPAIR_MAX_REGIONS_PER_PAGE = int(os.getenv("GLM_TEXT_LINE_REPAIR_MAX_REGIONS_PER_PAGE", "24"))
GLM_TEXT_LINE_REPAIR_DARK_THRESHOLD = int(os.getenv("GLM_TEXT_LINE_REPAIR_DARK_THRESHOLD", "165"))
GLM_TEXT_LINE_REPAIR_MIN_DARK_RATIO = float(os.getenv("GLM_TEXT_LINE_REPAIR_MIN_DARK_RATIO", "0.008"))
GLM_TEXT_LINE_REPAIR_LINE_GAP = int(os.getenv("GLM_TEXT_LINE_REPAIR_LINE_GAP", "8"))
GLM_TEXT_LINE_REPAIR_PAD_X = int(os.getenv("GLM_TEXT_LINE_REPAIR_PAD_X", "8"))
GLM_TEXT_LINE_REPAIR_PAD_Y = int(os.getenv("GLM_TEXT_LINE_REPAIR_PAD_Y", "6"))
GLM_TEXT_LINE_REPAIR_MAX_TOKENS = int(os.getenv("GLM_TEXT_LINE_REPAIR_MAX_TOKENS", "192"))
GLM_TEXT_LINE_REPAIR_REPETITION_PENALTY = float(
    os.getenv("GLM_TEXT_LINE_REPAIR_REPETITION_PENALTY", str(GLM_REPETITION_PENALTY))
)
