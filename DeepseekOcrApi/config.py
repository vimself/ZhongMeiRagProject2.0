...
PAGE_RECOVERY_SEGMENTS = int(os.getenv("OCR_PAGE_RECOVERY_SEGMENTS", "3"))
PAGE_RECOVERY_OVERLAP_RATIO = float(os.getenv("OCR_PAGE_RECOVERY_OVERLAP_RATIO", "0.08"))
PAGE_RECOVERY_ENABLED = os.getenv("OCR_PAGE_RECOVERY_ENABLED", "true").lower() not in {
    "0",
    "false",
    "no",
    "off",
}
PAGE_RECOVERY_MAX_PAGES = int(os.getenv("OCR_PAGE_RECOVERY_MAX_PAGES", "8"))
PAGE_RECOVERY_MAX_FAILED_SEGMENTS = int(os.getenv("OCR_PAGE_RECOVERY_MAX_FAILED_SEGMENTS", "1"))
PAGE_RECOVERY_MIN_SCORE = int(os.getenv("OCR_PAGE_RECOVERY_MIN_SCORE", "3"))
INCOMPLETE_PAGE_MIN_CHARS = int(os.getenv("OCR_INCOMPLETE_PAGE_MIN_CHARS", "20"))
